...
ggplot(df2, aes(x=projectedpoints, y=expectedplays))+ 
  geom_image(aes(image=images), size=0.1)+
  ggtitle("Projected Points & Expected Number of Plays for Each NFL Team Week 2", subtitle = "Expected Number of Points According to Vegas Betting Odds")+
  xlab("Implied Total Points")+ ylab("Expected Number of Plays")+ theme_bw()
